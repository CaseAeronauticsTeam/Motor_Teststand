...
def plt_thrust_vs_current(file_name, save):
    TITLE = "Motor Stress Test: Thrust vs Battery Current"
    ...
    for i in range(len(current)):
        paired.append([current[i], thrust[i]])
    paired.sort()
    ...
    plt.show()
    if save:
        fig.savefig("StressTest_ThrustVsCurrent.png", dpi=500)
...
if __name__ == "__main__":
    ...
    # Parse Args
    plt_thrust_vs_current(args[0], args[1], args[2])
